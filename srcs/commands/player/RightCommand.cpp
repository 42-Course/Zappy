...
RightCommand::RightCommand(World& world, const std::vector<std::string>& tokens, ClientConnection* client)
...
CommandStatus RightCommand::execute() {
    ...
    switch (dir) {
        case Direction::NORTH: player->setDirection(Direction::EAST); break;
        case Direction::EAST: player->setDirection(Direction::SOUTH); break;
        case Direction::SOUTH: player->setDirection(Direction::WEST); break;
        case Direction::WEST: player->setDirection(Direction::NORTH); break;
    }
